...
public class Recivedloans extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        savebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(Recivedloans.this, "Your Loan given to Someone  Has Been Saved", Toast.LENGTH_SHORT).show();
        ...
        selectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(Recivedloans.this,
